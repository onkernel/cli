...
- [Goreleaser Pro](https://goreleaser.com/install/) - **IMPORTANT: You must install goreleaser-pro, not the standard version, as this is required for our release process**
