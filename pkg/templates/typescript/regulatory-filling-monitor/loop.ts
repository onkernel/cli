...
import { DEFAULT_TOOL_VERSION, TOOL_GROUPS_BY_VERSION, ToolCollection, type ToolVersion } from './tools/collection.ts';
import { ComputerTool20241022, ComputerTool20250124 } from './tools/computer.ts';
import type { ActionParams } from './tools/types/computer.ts';
import { Action } from './tools/types/computer.ts';
import type { BetaMessageParam, BetaTextBlock } from './types/beta.ts';
import { injectPromptCaching, maybeFilterToNMostRecentImages, PROMPT_CACHING_BETA_FLAG, responseToParams } from './utils/message-processing.ts';
import { makeApiToolResult } from './utils/tool-results.ts';
